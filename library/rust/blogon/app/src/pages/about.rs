...
pub fn Index() -> impl IntoView {
    view! {
        ...
        <main class="about">
            ...
            <p>
                "I take interest in both learning and teaching, writing readable and dependable code. I like writing, and at this time, I intend to tell you about " <a href="https://clan.lol/">Clan</a> ", a framework to manage a small, distributed, fleet of NixOS servers. " <a href="/blog/0002-fly-io-sidecars-and-extra-luggage">"My first post"</a> " goes towards how I used Nixpkgs to do some edge networking on fly.io."
            </p>
            <p>
            ...
            <p>
                r#"Images: ⓒ Louis Opter, All rights reserved. Text: ⓒ Louis Opter, CC BY-SA 4.0. Bootstrap SVG icons: MIT License."#
            </p>
        </main>
    }
}
